...
import StaticHeaders from "../../projectsData/staticHeaders";
                    ...
                    visibleColumns.includes(index.toString()) && (
                      <td
                        ...
                        className={classNames(
                          ...
                          index === 0 ? "text-center" : "w-60"
                        )}
                        style={{
                          whiteSpace: "pre-wrap", // Ensure text wraps onto new lines
                          wordWrap: "break-word", // Handle breaking words
                          overflowWrap: "break-word", // Fallback for wordWrap
                          maxWidth: key === "अभ्यूक्ति" ? "500px" : "300px", // Differentiate column widths
                        }}
                      >
                        {key === "projectStatus" ? (
                          <p
